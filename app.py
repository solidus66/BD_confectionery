...
# TODO: возможность редактировать по клику, возможность добавлять/убирать тэги(wrapper);
#   в БД должна быть возможность добавлять новые продукты и производителей;
#   возможность редактировать информацию о продуктах, производителях;
